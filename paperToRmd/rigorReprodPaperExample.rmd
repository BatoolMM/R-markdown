...
![FIGURE 1 - Survey respondents#39; self-assessments of their knowledge and awareness of the current NIH guidelines on rigor and reproducibility.](desktop/Images_Paper/Fig1.jpg){#id .class width=50% height=50%}
...
![FIGURE 2 - Lack of requests for rigor and reproducibility documentation by users of shared resources. Response to the following multiple-choice question: Has your core&#39;s rigor and reproducibility practice statement ever been requested?](desktop/Images_Paper/Fig2.jpg){#id .class width=50% height=50%}
...
![FIGURE 3 - FIGURE 3 - Types of tools that cores would like to implement in their operations. Respondents were able to select more than 1 tool.](desktop/Images_Paper/Fig3.jpg){#id .class width=60% height=80%}
