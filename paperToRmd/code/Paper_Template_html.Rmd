...
![FIGURE 1 - Survey respondents'#39;' self-assessments of their knowledge and awareness of the current NIH guidelines on rigor and reproducibility.](../figs/fig1_paper.jpg){#id .class width=50% height=50%}
...
![FIGURE 2 - Lack of requests for rigor and reproducibility documentation by users of shared resources. Response to the following multiple-choice question: Has your core's rigor and reproducibility practice statement ever been requested?](../figs/fig2_paper.jpg){#id .class width=50% height=50%}
...
![FIGURE 3 - Types of tools that cores would like to implement in their operations. Respondents were able to select more than 1 tool.](../figs/fig3_paper.jpg){#id .class width=60% height=80%}
