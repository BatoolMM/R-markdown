...
Let's now follow the process to get a bibtex, using the example of the third item in our file `1,500 scientists lift the lid on reproducibility` authored by Baker (2016).
