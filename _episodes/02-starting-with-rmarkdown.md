...
- Anatomy of a Rmd File (YAML header, Text, Code chunks)
- How to knit a Rmd File to html
source: Rmd
---
...
> ## Exercise 1: Opening an RStudio project through the file system
>
> 1. Exit RStudio.
