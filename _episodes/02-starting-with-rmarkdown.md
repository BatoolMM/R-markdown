...
- Learn how to start an R markdown document & how it’s set up
...
FIXME: change Challenge 5 packages 
...
Start an R markdown document in RStudio by clicking File > New File > R Markdown…
