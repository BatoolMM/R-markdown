...
To start let’s identify where Figure 1 is first mentioned in the paper. There's a caption labeled "FIGURE 1 - Knowledge and awareness of the current NIH guidelines on rigor and reproducibility." We need to add the figure code in right above this.
...
> ## Time to Knit!
> Check how the figure you have just inserted looks like. 
{: .checklist}
