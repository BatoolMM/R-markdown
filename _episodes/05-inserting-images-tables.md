...
> There are some packages that allow you to make more advanced and interactive tables. Here are some references for these packages. 
> [https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.htm](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.htm) and [https://www.htmlwidgets.org/showcase_datatables.html](https://www.htmlwidgets.org/showcase_datatables.html)
{: .callout}
